...
#  Default: "Python 3.13.2 (tags/v3.13.2:4f8bb39, Feb  4 2025, 15:23:48) [MSC v.1942 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
# c.InteractiveShell.banner1 = "Python 3.13.2 (tags/v3.13.2:4f8bb39, Feb  4 2025, 15:23:48) [MSC v.1942 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
...
# matt- 5/3/2025 6:02:51 PM
#  no-worky because Token not imported and don't want to use those themes
# create new thims from broken themes - Matt - 5/4/2025 3:13:27 PM
#  theme_table.keys()
#  dict_keys(['nocolor', 'linux', 'neutral', 'neutral:nt', 'neutral:posix',
#             'lightbg', 'pride', 'pride:l', 'mydrac'])
themes = ['abap', 'algol_nu', 'algol', 'arduino', 'autumn',
          'borland', 'bw', 'coffee', 'colorful', 'default', 'dracula',
          'emacs', 'friendly_grayscale', 'friendly', 'fruity', 'gh_dark',
          'gruvbox', 'igor', 'inkpot', 'lightbulb', 'lilypond', 'lovelace',
          'manni', 'material', 'monokai', 'murphy', 'native', 'nord',
          'onedark', 'paraiso_dark', 'paraiso_light', 'pastie', 'perldoc',
          'rainbow_dash', 'rrt', 'sas', 'solarized', 'staroffice',
          'stata_dark', 'stata_light', 'tango', 'trac', 'vim', 'vs',
          'xcode', 'zenburn']
for t in list((tn, theme_table[tn]) for tn in ["linux", "neutral:posix", "pride",
                                         "pride:l"]):
    for tn in themes:
        curtheme = deepcopy(t[1])
        curtheme.base = tn
        curtheme.name = "{}_{}".format(t[0], tn)
        theme_table[curtheme.name] = curtheme

curnewtheme = 'pride:l_vim'
c.TerminalInteractiveShell.colors = curnewtheme
c.InteractiveShell.colors = curnewtheme
#
...
# c.TerminalInteractiveShell.banner1 = "Python 3.13.2 (tags/v3.13.2:4f8bb39, Feb  4 2025, 15:23:48) [MSC v.1942 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 9.0.2 -- An enhanced Interactive Python. Type '?' for help.\n"
